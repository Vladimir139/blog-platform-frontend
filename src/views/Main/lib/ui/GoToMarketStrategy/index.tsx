...
export const GoToMarketStrategy: FC = () => {
  const isMobile = useMedia("(max-width: 580px)", false);
  ...
  return (
    <S.Wrapper>
      ...
      <S.DescriptionInitiatives>
        These initiatives represent just a few facets of our comprehensive marketing strategy. We
        will continually push and work on getting on exchanges and more as we gain more traction and
        users for our products and services.
      </S.DescriptionInitiatives>
    </S.Wrapper>
  );
};
