    ...
    <S.Percentages>
      ...
      <CellWithDots css={{ height: 383, padding: "45px 17px 48px 44px", alignItems: "start" }}>
        <S.TokenInfoBlock bigGap>
          ...
          <S.BlockValue bigValue>
            This is a multi-faceted allocation that includes: a.)RevShare: Continuing our commitment
            to sharing our success with our community. <br /> b.) Buybacks: Tokens bought back are
            burnt forever.
          </S.BlockValue>
        </S.TokenInfoBlock>
      </CellWithDots>
