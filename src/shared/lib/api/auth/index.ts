...
export const authApi = {
  register: async (payload: LoginFormFields): Promise<AxiosPromise<AuthResponse>> =>
    axios.post(authUrls.register, payload),
  login: async (
    payload: Omit<RegisterFormFields, "confirmPassword">,
  ): Promise<AxiosPromise<AuthResponse>> => axios.post(authUrls.login, payload),
